...
%>
<fieldset style="position:relative; margin-top:5px; margin-right:40px; position:relative; background:url(images/index/logout.png) no-repeat; border:0px; width:201px; height:61px; float:right;">
<font style="position:absolute; top:3px; left:77px;"><%=name%></font>
<a href="#"><IMG border=0 style="position:absolute; bottom:3px; left:50px;" SRC="images/index/news.png" onmouseover="this.src='images/index/news1.png'" onmouseout="this.src='images/index/news.png'"></a>
<a href="logout.jsp"><IMG border=0 style="position:absolute; bottom:3px; left:135px;" SRC="images/index/log2.png" onmouseover="this.src='images/index/log3.png'" onmouseout="this.src='images/index/log2.png'"></a>
</fieldset>
<%
	}
	else
	{
%>
<fieldset style="position:relative; margin-top:5px; margin-right:40px; position:relative; background:url(images/index/login.png) no-repeat; border:0px; width:162px; height:61px; float:right;">
<a href="login.jsp"><IMG border=0 style="position:absolute; bottom:4px; left:50px;" SRC="images/index/log.png" onmouseover="this.src='images/index/log1.png'" onmouseout="this.src='images/index/log.png'"></a>
<a href="member_step1.jsp"><IMG border=0 style="position:absolute; bottom:4px; left:100px;" SRC="images/index/reg.png" onmouseover="this.src='images/index/reg1.png'" onmouseout="this.src='images/index/reg.png'"></a>
</fieldset>
<%
	}
%>
...
<div class="navinner">
  ...
  <li><a href="#" id="nav_1" onmouseover="showMenu('nav_1','subnav1')">健康測驗</a>
    <div class="subnav disable" id="subnav1">
      ...
      <a href="a.jsp">健康診斷</a> |
      <a href="http://localhost:83/ehealth/image_diag.jsp">圖像偵測
      </span></p>
    </div>  
  </li>
  ...
  <li><a href="http://140.136.155.115:83/discuss/discuss_index.jsp" id="nav_5" onmouseover="showMenu('nav_5','subnav5')">討論區</a>
