...
<div style="background:url(images/index/background.jpg) repeat; margin-top:2px; padding-top:20px">
	<div style="width:900px; height:700px; margin:0 auto 0 auto">
		...
		<div style="position:relative; width:898px; height:370px; background:url(images/index/index_bg.gif) repeat-y;">
			<img style="position:absolute; top:40px; left:130px" src="images/index/call_us.png">
			<img style="position:absolute; bottom:30px; right:130px" src="images/index/call_us_home.png">
		</div>
